      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse"  style="position: relative;">
          ...
          <ul id="member-menu" class="nav navbar-nav navbar-right hidden-xs">
            <li id="parent-cart"><a href="#" class="shopping-cart">
							<span class="shopping-cart-count badge">0</span>
							<i class="glyphicon glyphicon-shopping-cart"></i> 
							<span class="visible-xs">Shopping Cart</span></a>
						</li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> <span class="visible-xs">Account</span> <b class="caret"></b></a>
          ...
          <ul id="member-menu2" class="nav navbar-nav navbar-right visible-xs">
            <li id="parent-contact"><a href="/contact/"><i class="glyphicon glyphicon-envelope"></i> <span class="visible-xs">Contact Us</span></a></li>
            <li><a href="#"><i class="glyphicon glyphicon-shopping-cart"></i> <span class="visible-xs">Shopping Cart</span></a></li>
          ...
          <ul id="search-menu" class="item-search nav navbar-nav navbar-right hidden-xs">
           <li><a href="#" class="collapsed" data-toggle="collapse" data-target="#search-box"><i class="glyphicon glyphicon-search"></i></a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
      <div id="search-box" class="hidden-xs collapse" role="search">
        <div class="container">
